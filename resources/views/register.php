...
<body class="loginMark" ng-app="schoex" ng-controller="registeration">
    <!-- ============================================================== -->
    ...
    <section id="wrapper" <?php if($panelInit->settingsArray['registerPageStyle'] == "r"){ echo 'class="login-register login-sidebar" style="'.$bgStyling.'"'; } ?>>
        <div <?php if($panelInit->settingsArray['registerPageStyle'] == "r"){ echo 'class="login-box card"'; }else{ echo 'class="login-register" style="'.$bgStyling.'; background-size: cover;background-attachment: fixed;position:static !important;"'; } ?> >
            ...
            <div class="card-block" style="overflow-y: scroll;">
                    ...
                    <div ng-show="views.register" class="registerationForm">
                        <form class="form-horizontal form-material" id="loginform" ng-submit="tryRegister()" method="post" role="form" name="registerationForm">
                            ...
                            <div class="form-group">
                                <div class="col-xs-12">
                                    <input date-picker type="text" name="birthday" id="datemask" class="form-control datemask" placeholder="<?php echo $panelInit->language['Birthday']; ?>" ng-model="form.birthday"/>
                                </div>
                            </div>
    ...
    <script src="<?php echo URL::asset('/assets'); ?>/plugins/bootstrap/js/popper.min.js" integrity="sha384-b/U6ypiBEHpOf/4+1nzFpr53nxSS+GLCkfwBdFNTxtclqqenISfwAzpKaMNFNmj4" crossorigin="anonymous"></script>
