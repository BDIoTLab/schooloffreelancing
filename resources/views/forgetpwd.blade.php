...
<body class="loginMark">
    ...
    <section id="wrapper" <?php if($panelInit->settingsArray['forgetPwdPageStyle'] == "r"){ echo 'class="login-register login-sidebar" style="'.$bgStyling.'"'; } ?>>
        <div <?php if($panelInit->settingsArray['forgetPwdPageStyle'] == "r"){ echo 'class="login-box card"'; }else{ echo 'class="login-register" style="'.$bgStyling.'"'; } ?> >
            <?php if($panelInit->settingsArray['forgetPwdPageStyle'] == "c"){ ?><div class="login-box card"><?php } ?>
            <div class="card-block">
                <form class="form-horizontal form-material" id="loginform" action="{{URL::to('/forgetpwd')}}" method="post">
                    ...
                    @if(isset($success))
                        ...
                        <div class="form-group m-b-0">
                            <div class="col-sm-12 text-center">
                                <p><a href="{{URL::to('/')}}" class="text-info m-l-5"><b><?php echo $panelInit->language['loginToAccount']; ?></b></a></p>
                            </div>
                        </div>
                    @else
                        @if($errors->any())
                        ...
                        <div class="form-group text-center m-t-20">
                            <div class="col-xs-12">
                                ...
                                <button class="btn btn-info btn-lg btn-block text-uppercase waves-effect waves-light" type="submit"><?php echo $panelInit->language['restorePwd']; ?></button>
                            </div>
                        </div>
