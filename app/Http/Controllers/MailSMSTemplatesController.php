...
class MailSMSTemplatesController extends Controller {
	...
	public function __construct(){
		...
		if(!$this->panelInit->hasThePerm('mailsmsTemplates')){
			exit;
		}
	}
	...
	function add(){
		...
		return $this->panelInit->apiOutput(true,$this->panelInit->language['addTemplate'],$this->panelInit->language['templateAdded']);
	}
