...
Route::group( array('middleware'=>'web') ,function(){
  ...
  Route::get('/test','MailSmsController@create');
  ...
  Route::get('/invoices/search/{keyword}/{page}','invoicesController@search');
	...
	Route::get('/history/export','reportsController@export');
	...
	Route::get('/invoices_add','invoicesController@fetch_add');
    ...
    Route::get('/reports','DashboardController@index');
		Route::get('/reports/{id}','reportsController@invoice_student');
