...
<body class="loginMark">
    ...
    <section id="wrapper">
        <div class="login-register" style="<?php echo $bgStyling; ?>background-size: cover;background-attachment: fixed;position:static !important;" >
            <div class="login-box card" style="width:400px;">
            <div class="card-block">
                <p class="login-box-msg text-center">Upgrade to Schoex 3.1</p>
                    ...
                    <div class="body">
                        ...
                        @if($currStep == "welcome")
                            ...
                            <div class="form-group">
                                ...
                                <button type="submit" class="btn bg-primary btn-block">Start upgrade process</button>
                            </div>
                        @endif
                        @if($currStep == "1")

                            <div class="form-group" style="color:red;font-wieght:bold;">
                                <center><b>Warning</b> <br/> Schoex 3 includede new system for invoices, Some of old data may be not accessible and needs reconfiguration from yourside.</center>
                            </div>
